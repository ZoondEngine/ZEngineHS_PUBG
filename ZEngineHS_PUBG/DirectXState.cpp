...
DirectXState::DirectXState() : m_savedState(false), m_featureLevel(D3D_FEATURE_LEVEL_11_0), m_pContext(NULL), m_primitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_UNDEFINED), m_pInputLayout(NULL), m_pBlendState(NULL),
...
HRESULT DirectXState::saveCurrentState(ID3D11DeviceContext* pContext)
{
...
HRESULT DirectXState::restoreSavedState()
{
...
void DirectXState::ZeroShaders(ID3D11DeviceContext* pContext)
{
...
void DirectXState::releaseSavedState()
{
